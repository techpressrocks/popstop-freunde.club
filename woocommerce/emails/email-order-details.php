...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	<thead>
		<tr>
			<th class="td" scope="col" style="text-align:left;">Mitgliedschaft</th>
			<th class="td" scope="col" style="text-align:left;">Anzahl</th>
			<th class="td" scope="col" style="text-align:left;">Mitgliedsbeitrag</th>
		</tr>
	</thead>
	<tbody>
