...
<div class="woocommerce_account_subscriptions">
	...
	<h2><?php esc_html_e( 'Meine Mitgliedschaft', 'woocommerce-subscriptions' ); ?></h2>
	<?php endif; ?>
	...
	<thead>
		<tr>
			<th class="subscription-id order-number"><span class="nobr"><?php esc_html_e( 'Mitgliedschaft', 'woocommerce-subscriptions' ); ?></span></th>
